  ...
  return (
    <div className='py-7 border-b-2'>
      <p className='text-center'>
        ...
        <span className='text-xl font-bold'>cooking </span>, blending flavors
        and code to create delightful experiences. Join me as I explore the
        worlds of programming and gastronomy!
      </p>
    </div>
  );
}
